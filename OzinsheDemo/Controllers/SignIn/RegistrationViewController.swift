...
//        emailTextField.layer.borderColor = UIColor(red: 0.90, green: 0.92, blue: 0.94, alpha: 1.00).cgColor
        emailTextField.layer.borderColor = UIColor(named: "#E5EBF0 - #374151")?.cgColor
...
//        var SigninVC = storyboard?.instantiateViewController(identifier: "SingInViewController") as! SingInViewController
